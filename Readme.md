Fork of [jbkjr/train-procgen-pytorch](https://github.com/jbkjr/train-procgen-pytorch). I just added the ability to choose to train with disabled backgrounds.
